...
public final class FindMeetingQueryTest {
  ...
  public void notEnoughRoom() {
    ...
    public void busyOptionalAttendee() {
        // Have mandatory attendee have different events. Give optional attendee a full schedule.
        // We should still see three options because the optional attendee cannot meet at all.
        //
        // Events  :       |--A--|     |--B--|
        // Day     : |--------------C--------------|
        // Day     : |-----------------------------|
    ...
    public void optionalAttendeeIsConsidered() {
        // Have mandatory attendee have different events. Give optional attendee only one busy TimeRange.
        // We should see only two TimeRanges since the optional attendee cannot attend one of the two
        // TimeRanges that the mandatory attendees have available.
        //
        // Events  :       |--A--|     |--B--|
        // Events  :             |--C--|
        // Day     : |-----------------------------|
    ...
    @Test
    public void notEnoguhRoomForOptional() {
        // Have one mandatory, but make it so that there is just enough room at one point in the day to
        // have the meeting.
        //
        // Events  : |--A--|     |----A----|
        // Day     : |---------------------|
    ...
    @Test
    public void optionalAttendeesWithSeveralGaps() {
        // Have mandatory attendee have different events. Give optional attendee only one busy TimeRange.
        // We should see only two TimeRanges since the optional attendee cannot attend one of the two
        // TimeRanges that the mandatory attendees have available.
        //
        ...
        Collection<Event> events = Arrays.asList(
            ...
            new Event("Event 5", TimeRange.fromStartDuration(TIME_1000AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_B)),
            new Event("Event 6", TimeRange.fromStartDuration(TIME_1100AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_B)));
    ...
    public void optionalAttendeesWithNoGaps() {
        // Have optional attendees have all day events. We should see no available times.
        //
        // Events  : |--------------A--------------|
        // Events  : |--------------B--------------|
        // Day     : |-----------------------------|
